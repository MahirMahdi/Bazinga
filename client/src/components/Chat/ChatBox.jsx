      ...
      {currentConversation ? (
        <>
          <ChatHeader
            ...
            convoId={currentConversation._id}
            chatUser={chatUser}
            ...
            <div className="wrapper">
              {currentConversation.texts.map((text) => (
                <Conversation
                  ...
                  sent={text.sender_id === user.user._id ? text : null}
                />
              ))}
            </div>
          </div>
          <Snackbar open={open} autoHideDuration={600} onClose={handleClose}>
            <Alert
              severity="success"
              sx={{ marginBottom: "50vh", marginLeft: "25vw", width: "10rem" }}
            >
              Image added!
            </Alert>
          </Snackbar>
        ...
        <>
          <ChatHeader
            ...
            handleClick={handleClick}
          />
          <div className="chat-body start-convo" onClick={emojiClose}>
